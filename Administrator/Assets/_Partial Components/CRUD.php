               ...
               $output .='<tr> 
                ...
                $output .='
                 <tr>
                    ...
                    <td>' .$row["Source"]. '</td>
                    <td>' .$row["Date"]. '</td>
                    <td style = "width: 6%;"> <a href="" class = "edit-news" id = "' .$row["News_ID"]. '" style="color: #32C5D2;" data-toggle="tooltip" data-placement="top" title="Edit News"> <i class = "fa fa-pencil"></i> Edit </a></td>
                    <td style = "width: 7%;" > <a href="" class = "delete-news" id = "' .$row["News_ID"]. '" style="color: #D05454;"  data-toggle="tooltip" data-placement="top" title="Delete News"> <i class = "fa fa-times"></i> Delete </a> </td>
                 </tr>
                 ';
            }$i++;
    }
...
public function Load_User_Data(){
        $output = '';
        $query = "SELECT * FROM Viw_Users order by User_ID desc";
        $result = $this->db->select($query);
        mysqli_set_charset($this->db->link, 'UTF8');
        $output .='
        <table class="table table-stripped table-hover">
